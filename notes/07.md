...
Decoder-only预训练语言模型代表了自回归生成的极致体现，以GPT系列为典型代表。这种架构的核心哲学是：**通过预测下一个词来学习语言的本质规律**。
...
2. **训练技术论文**：
   ...
   - "Constitutional AI: Harmlessness from AI Feedback" (Constitutional AI)
